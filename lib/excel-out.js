...
export async function buildExcel(result) {
  ...
  wb.creator = "Todd Jr's Pizzeria — Rent Roll Chef"
  wb.created = new Date()
...
function buildSummarySheet(wb, data) {
  ...
  cell(ws, r, 1, "TODD JR'S PIZZERIA — RENT ROLL RECONCILIATION", { fill: NAVY, color: WHITE, bold: true, size: 13, align: 'center' })
